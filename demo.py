...
parser = argparse.ArgumentParser(description='Test TPMNet on your own images')
...
parser.add_argument('--task', default='Deraining', type=str, help='Task to run', help='Deraining task')
